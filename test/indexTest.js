...
describe("index.js", function () {
  ...
  describe("mySortBy", function () {
    ...
    it("correctly sorts arrays of integers and arrays of strings", function () {
      ...
      expect(
        arraysEqual(mySortBy(unsortedStringArr, sortArrFunction), [
          "choux",
          "coconut",
          "doge",
          "maru",
    ...
    it("does not modify the original arrays", function () {
      ...
      expect(arraysEqual(unsortedIntArr, [3, 8, 5, 1, 9, 11, 8])).to.equal(
        true
      );
      expect(
        arraysEqual(unsortedStringArr, ["maru", "choux", "doge", "coconut"])
      ).to.equal(true);
    });
    ...
    it("correctly sorts arrays of integers with non-standard sort", function () {
      expect(
        arraysEqual(
          mySortBy([1, 2, 3, 4, 5, 6], sortIntsBySin),
          [5, 4, 6, 3, 1, 2]
        )
      ).to.equal(true);
    });
